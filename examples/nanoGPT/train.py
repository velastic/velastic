...
if __name__ == "__main__":
    ...
    torch.backends.cudnn.benchmark = False # for reproducibility, disable cudnn autotuner
    ...
    assert ddp, "velastic only supports DDP, FSDP, FSDP2"
    if ddp:
    ...
    # velastic: define a function to get extra state for checkpointing
    # This should be defined based on the specific training code
    def get_extra_state():
        return {
            "iter_num": iter_num,
    ...
    # velastic: initialize the velastic IterManager
    ...
    # velastic: resume model and optimizer state
    # This needs to be consistent with the previous get_extra_state.
